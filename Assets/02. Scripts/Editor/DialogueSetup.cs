...
public static class DialogueSetup
{
    ...
    private static List<DialogueGroup> BuildSampleGroups()
    {
        return new List<DialogueGroup>
        {
            ...
            Group(ColorType.Gray,
                Line("아직도 그게 떠올라요. 역겨웠거든요. 왜 사람이 그럴 수 있는지, 으읏.... 토 나오네요.", nameOverride: "20살 12월의 기억"),
                Line("처음부터 역겨웠어요. 몸에서는 이상한 냄새가 나지 얼굴도 기괴하게 생겼지, 가까이하고 싶지 않았는데, 진작 거리를 둬야했어요.", nameOverride: "20살 12월의 기억"),
                Line("그 자리에 있었던 게 후회돼요. 너무 끔찍한걸 목격했거든요. 아무리 잊으려 해도 잊어지지가 않아요.", nameOverride: "20살 12월의 기억"),
                Line("그 눈빛이 싫었어요. 항상 뭔가를 계산하는 것 같은 눈이요. 웃을 때마다 소름이 돋았어요. 그런 사람인 줄 알았어요, 처음부터.", nameOverride: "20살 12월의 기억"),
                Line("왜 나만 그 사람이 이상하다는 걸 알았을까요. 다들 좋다고 했는데. 내가 틀린 건지, 나만 진실을 본 건지. 지금도 모르겠어요.", nameOverride: "20살 12월의 기억"),
                Line("그 사람 생각만 하면 몸이 굳어요. 같은 공간에 있었다는 것만으로도 더러운 것 같아서 집에 와서 씻었어요. 그 기억은 아무리 씻어도 안 지워지더라고요.", nameOverride: "20살 12월의 기억")),

            // ── Black (공포·목격) ────────────────────────────────
            // 서사: 눈 앞에서 일어난 죽음 — 도망치지도 막지도 못한 공포
            Group(ColorType.Black,
                Line("여전히 무서워요. 높은 곳에서 바닥을 바라볼 때면 금방이라도 떨어질 것만 같아서요. 물리적인 것도 그렇지만, 사회적으로도 나락으로 떨어질 것만 같아요. 마치 그 친구의 인생처럼...", nameOverride: "20살 12월의 기억"),
                Line("그때 정말 무서웠어요. 앞이 아무것도 안 보이는 것 같았어요. 사람이 눈 앞에서 죽었는걸요. 그때 그 공포는 지금도 남아있어요. 지금도 손이 떨리네요... 스읍... 하... 심호흡을 하죠.", nameOverride: "20살 12월의 기억"),
                Line("처음으로 진짜 무서운 게 뭔지 알았어요. 귀신이 제일 무서운 줄 알았는데, 사람이 더 무서울 수도 있다는 걸 알았어요. 그것도 가까운 사람이.... 어떻게 그럴수가....", nameOverride: "20살 12월의 기억"),
                Line("그 소리가 아직도 귀에 남아있어요. 쿵 소리요. 뛰어가지 말았어야 했는데, 뛰어가서 봤어요. 다 봤어요. 그래서 더 무서운 거예요.", nameOverride: "20살 12월의 기억"),
                Line("몸이 안 움직였어요. 소리도 못 질렀어요. 그냥 서있었어요. 그게 지금도 제일 이해가 안 돼요. 왜 그때 아무것도 못 했는지.", nameOverride: "20살 12월의 기억"),
                Line("눈을 감으면 그 표정이 떠올라요. 쓰러질 때 그 얼굴이요. 제일 무서운 건, 그 표정이 가끔 낯익다는 거예요.", nameOverride: "20살 12월의 기억")),

            // ── DeepBlack (붕괴·부정·전가) ───────────────────────
            // 서사: 책임 부정 → 타인에게 전가 → 자책 → 공허한 자기 위로
            Group(ColorType.DeepBlack,
                Line("<color=red><b>아니야아니야아니야아니야아니야아니야아니야아니야아니야아니야내가아니야내가아니야내가아니야내가아니야내가아니야내가죽이지않았어내가죽이지않았어내가죽이지않았어내가죽이지않았어내가죽이지않았어그녀석이야그녀석이야그녀석이야그녀석이야그녀석이야니가죽인거야니가죽인거야니가죽인거야니가죽인거야니가죽인거야니가죽인거야니가죽인거야니가죽인거야니가죽인거야니가죽인거야</b></color>", nameOverride: "20살 12월의 기억"),
                Line("<color=red><b>죄송해요죄송해요죄송해요죄송해요죄송해요죄송해요죄송해요죄송해요죄송해요죄송해요죄송해요잘못했어요잘못했어요잘못했어요잘못했어요잘못했어요잘못했어요잘못했어요잘못했어요잘못했어요잘못했어요잘못했어요잘못했어요잘못했어요잘못했어요잘못했어요잘못했어요잘못했어요잘못했어요다신안그럴게요다신안그럴게요다신안그럴게요다신안그럴게요다신안그럴게요다신안그럴게요다신안그럴게요다신안그럴게요다신안그럴게요</b></color>", nameOverride: "20살 12월의 기억"),
    ...
    private static DialogueLine Line(string text, int minAge = -1, int maxAge = -1, string nameOverride = null) =>
        new DialogueLine { text = text, minAge = minAge, maxAge = maxAge, nameOverride = nameOverride };
